        ...
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    ...
                    """,
                    reverse_sql="""
                    ALTER TABLE core_siteconfig DROP COLUMN IF EXISTS tax_percentage;
                    ALTER TABLE core_siteconfig DROP COLUMN IF EXISTS free_delivery_threshold;
                    ALTER TABLE core_siteconfig DROP COLUMN IF EXISTS delivery_fee;
                    ALTER TABLE core_siteconfig DROP COLUMN IF EXISTS customer_platform_fee;
                    """
                )
            ]
        )
