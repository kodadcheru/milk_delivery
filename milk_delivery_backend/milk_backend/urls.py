...
urlpatterns = [
    ...
    path("api/admin/hubs/<int:pk>/", AdminHubDetailView.as_view(), name="admin_hub_detail"),
    path("api/admin/hubs/<int:pk>/assign-driver/", AdminHubAssignDriverView.as_view(), name="admin_hub_assign_driver"),
