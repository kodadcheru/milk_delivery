...
from apps.accounts.admin_views import (
    ...
    AdminSubscriptionsResetView,
    AdminDatabaseCompleteResetView,
    HubDriverCreateView,
...
from apps.deliveries.chat_views import (
    DeliveryChatSendView,
    DeliveryChatHistoryView,
)
...
from apps.deliveries.views import (
    ...
    DeliveryTaskStatusUpdateView,
    DeliveryShiftStartRouteView,
...
urlpatterns = [
    ...
    path("api/admin/subscriptions/reset/", AdminSubscriptionsResetView.as_view(), name="admin_subscriptions_reset"),
    path("api/admin/reset-database/", AdminDatabaseCompleteResetView.as_view(), name="admin_reset_database"),
    ...
    path("api/deliveries/<int:pk>/status/", DeliveryTaskStatusUpdateView.as_view(), name="delivery_status_update"),
    path("api/deliveries/start-route/", DeliveryShiftStartRouteView.as_view(), name="delivery_start_route"),
    ...
    path("api/deliveries/auto-dispatch-daily-tasks/", AutoDispatchDailyTasksView.as_view(), name="auto_dispatch_daily_tasks"),
