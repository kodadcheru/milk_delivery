...
def seed():
    ...
    # 1. Permanent Super Admin (zero hardcoded hubs or mock data)
    ...
    # NOTE: ZERO hubs, categories, products, or subscriptions are seeded automatically.
    # All infrastructure is created and managed dynamically via Admin Web Console.
    print("✅ [Railway DB Initializer] Ready! All hubs, categories & items are 100% dynamic.")
