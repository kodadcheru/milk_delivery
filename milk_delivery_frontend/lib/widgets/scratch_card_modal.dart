...
class _ScratchCardRewardModalState extends State<ScratchCardRewardModal> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scaleAnimation = TweenSequence<double>([
      ...
      TweenSequenceItem(tween: Tween(begin: 1.05, end: 1.0).chain(CurveTween(curve: Curves.bounceOut)), weight: 50),
  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      child: Stack(
        ...
        children: [
          // Back card (3rd layer - smallest, most rotated)
          Transform(
          ...
          // Front card (main content - existing scratch card)
          ScaleTransition(
                                    ...
                                    builder: (context, child) {
                                      return Positioned.fill(
                                        child: FractionalTranslation(
                                          translation: Offset(_shimmerController.value * 2 - 1.5, 0),
                                          child: Container(
                                            decoration: BoxDecoration(
