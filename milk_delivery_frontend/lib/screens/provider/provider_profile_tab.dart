      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 14),
            _buildSupportTile(context, Icons.local_shipping_rounded, 'Milk Supply Shortfall / Excess Request', AppConfig.supportPhone),
            _buildSupportTile(context, Icons.shopping_bag_outlined, 'Packaging Pouches & Crates Reorder', AppConfig.supportPhone),
            _buildSupportTile(context, Icons.build_rounded, 'Chiller Equipment & Maintenance SOS', AppConfig.supportPhone),
            const SizedBox(height: 12),
          ],
        ),
      ),
